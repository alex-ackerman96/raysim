...
class AnimatedToggle(QCheckBox):
    ...
    _light_grey_pen = QPen(QColor("#2d3f52"))

    def __init__(self,
        parent=None,
        bar_color=QColor("#2d3f52"),
        checked_color="#08a3f9",
        handle_color=QColor("#57718c"),
        pulse_unchecked_color="#20f0f0f0",
        pulse_checked_color="#3308a3f9"
        ):
        ...
        self.pulse_anim.setDuration(300)  # time in ms
